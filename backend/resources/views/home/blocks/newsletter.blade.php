...
<section class="bg-pinksoft py-10 text-center md:py-[60px]">
  <div class="mx-auto w-full max-w-wrapper px-3 md:px-4">
    ...
    <form class="mx-auto flex max-w-[520px] flex-col gap-2.5 sm:flex-row" data-newsletter>
      ...
      <button class="inline-flex items-center justify-center gap-2 border border-black bg-black px-8 py-[13px] text-[13px] font-medium uppercase tracking-[0.5px] text-white transition-colors hover:border-accent hover:bg-accent" type="submit">Subscribe</button>
    </form>
